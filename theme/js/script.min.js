(() => {
  ...
  (function(document2) {
    ...
    function addClass2(format, support) {
      if (support) {
  ...
  var interpolate = function interpolate2(start, end, progress, mutate) {
    ...
    if (!func) {
      var isString3 = _isString(start), master = {}, p2, i2, interpolators, l2, il;
  ...
  var _revertStyle = function _revertStyle2() {
    var props = this.props, target = this.target, style2 = target.style, cache2 = target._gsap, i2, p2;
  ...
  var Observer = /* @__PURE__ */ function() {
    ...
    _proto.init = function init5(vars) {
      ...
      var id, onStopDelayedCall, dragged, moved, wheeled, locked, axis, self = this, prevDeltaX = 0, prevDeltaY = 0, passive = vars.passive || !preventDefault2, scrollFuncX = _getScrollFunc(target, _horizontal), scrollFuncY = _getScrollFunc(target, _vertical), scrollX = scrollFuncX(), scrollY = scrollFuncY(), limitToTouch = ~type2.indexOf("touch") && !~type2.indexOf("pointer") && _eventTypes[0] === "pointerdown", isViewport = _isViewport(target), ownerDoc = target.ownerDocument || _doc3, deltaX = [0, 0, 0], deltaY = [0, 0, 0], onClickTime = 0, clickCapture = function clickCapture2() {
        ...
        return _ignoreCheck(e2) || _getEvent(e2, preventDefault2) && onClick(self);
      };
  ...
  var _enabled = 0;
  var _parseClamp = function _parseClamp2(value, type2, self) {
    var clamp3 = _isString3(value) && (value.substr(0, 6) === "clamp(" || value.indexOf("max") > -1);
    self["_" + type2 + "Clamp"] = clamp3;
  ...
  var _setState = function _setState2(state) {
    if (state) {
      var style2 = state.t.style, l2 = state.length, i2 = 0, p2, value;
  ...
  var ScrollTrigger2 = /* @__PURE__ */ function() {
    ...
    ScrollTrigger4.scrollerProxy = function scrollerProxy(target, vars) {
      var t3 = _getTarget(target), i2 = _scrollers.indexOf(t3), isViewport = _isViewport3(t3);
      if (~i2) {
  ...
  var _getScrollNormalizer = function _getScrollNormalizer2(vars) {
    ...
    vars.onChange = function(self2, dx, dy, xArray, yArray) {
      ...
      if (dy) {
        scrollFuncY.offset && removeContentOffset();
        var isTouch2 = yArray[2] === dy, y2 = isTouch2 ? startScrollY + self2.startY - self2.y : scrollFuncY() + dy - yArray[1], yClamped = scrollClampY(y2);
  ...
  function each(t3, n2) {
    if (isArrayLike(t3)) {
      for (let o2 = 0; o2 < t3.length; o2++) {
        if (n2(t3[o2], o2, t3) === false) {
          break;
        }
      }
    } else if (t3) {
      each(Object.keys(t3), (o2) => n2(t3[o2], o2, t3));
    }
    return t3;
  }
  function style(t3, n2) {
    const o2 = isString(n2);
    const s2 = isArray(n2) || o2;
    if (s2) {
      let s3 = o2 ? "" : {};
      if (t3) {
        const e2 = window.getComputedStyle(t3, null);
        s3 = o2 ? getCSSVal(t3, e2, n2) : n2.reduce((n3, o3) => {
          n3[o3] = getCSSVal(t3, e2, o3);
          return n3;
        }, s3);
      }
      return s3;
    }
    t3 && each(keys(n2), (o3) => setCSSVal(t3, o3, n2[o3]));
  }
  var createCache = (t3, n2) => {
    const { o: o2, u: s2, _: e2 } = t3;
    let c2 = o2;
    let r2;
    const cacheUpdateContextual = (t4, n3) => {
      const o3 = c2;
      const l2 = t4;
    ...
    const cacheUpdateIsolated = (t4) => cacheUpdateContextual(n2(c2, r2), t4);
    const getCurrentCache = (t4) => [c2, !!t4, r2];
  ...
  var isUndefined = (t3) => t3 === void 0;
  var isNull = (t3) => t3 === null;
  var type = (t3) => isUndefined(t3) || isNull(t3) ? `${t3}` : n.call(t3).replace(/^\[object (.+)\]$/, "$1").toLowerCase();
  var isNumber = (t3) => typeof t3 === "number";
  var isString = (t3) => typeof t3 === "string";
  var isBoolean = (t3) => typeof t3 === "boolean";
  var isFunction = (t3) => typeof t3 === "function";
  var isArray = (t3) => Array.isArray(t3);
  var isObject = (t3) => typeof t3 === "object" && !isArray(t3) && !isNull(t3);
  var isArrayLike = (t3) => {
    const n2 = !!t3 && t3.length;
    const o2 = isNumber(n2) && n2 > -1 && n2 % 1 == 0;
    return isArray(t3) || !isFunction(t3) && o2 ? n2 > 0 && isObject(t3) ? n2 - 1 in t3 : true : false;
  };
  var isPlainObject = (t3) => {
    if (!t3 || !isObject(t3) || type(t3) !== "object") {
      return false;
    }
    let n2;
    ...
    return isUndefined(n2) || o.call(t3, n2);
  };
  ...
  var indexOf = (t3, n2, o2) => t3.indexOf(n2, o2);
  var push = (t3, n2, o2) => {
    !o2 && !isString(n2) && isArrayLike(n2) ? Array.prototype.push.apply(t3, n2) : t3.push(n2);
    return t3;
  };
  var from = (t3) => {
    const n2 = Array.from;
  ...
  var isEmptyArray = (t3) => !!t3 && t3.length === 0;
  var runEachAndClear = (t3, n2, o2) => {
    const runFn = (t4) => t4 && t4.apply(void 0, n2 || []);
    each(t3, runFn);
    !o2 && (t3.length = 0);
  };
  var hasOwnProperty = (t3, n2) => Object.prototype.hasOwnProperty.call(t3, n2);
  var keys = (t3) => t3 ? Object.keys(t3) : [];
  var assignDeep = (t3, n2, o2, s2, e2, c2, r2) => {
    const l2 = [n2, o2, s2, e2, c2, r2];
    if ((typeof t3 !== "object" || isNull(t3)) && !isFunction(t3)) {
      t3 = {};
    }
    each(l2, (n3) => {
      each(keys(n3), (o3) => {
        ...
        if (s3 && isPlainObject(s3)) {
          ...
          t3[o3] = assignDeep(c3, s3);
        } else {
          t3[o3] = e3 ? s3.slice() : s3;
        }
      });
    });
    return t3;
  };
  var isEmptyObject = (t3) => {
    for (const n2 in t3) {
      return false;
    }
    return true;
  };
  var getSetProp = (t3, n2, o2, s2) => {
    if (isUndefined(s2)) {
      return o2 ? o2[t3] : n2;
    }
    o2 && (isString(s2) || isNumber(s2)) && (o2[t3] = s2);
  };
  var attr = (t3, n2, o2) => {
    if (isUndefined(o2)) {
      return t3 ? t3.getAttribute(n2) : null;
    }
    t3 && t3.setAttribute(n2, o2);
  };
  var getValueSet = (t3, n2) => new Set((attr(t3, n2) || "").split(" "));
  var removeAttr = (t3, n2) => {
    t3 && t3.removeAttribute(n2);
  };
  var attrClass = (t3, n2, o2, s2) => {
    if (o2) {
      const e2 = getValueSet(t3, n2);
      e2[s2 ? "add" : "delete"](o2);
      const c2 = from(e2).join(" ").trim();
      attr(t3, n2, c2);
    }
  };
  var hasAttrClass = (t3, n2, o2) => getValueSet(t3, n2).has(o2);
  var scrollLeft = (t3, n2) => getSetProp("scrollLeft", 0, t3, n2);
  var scrollTop = (t3, n2) => getSetProp("scrollTop", 0, t3, n2);
  var s = isClient() && Element.prototype;
  var find = (t3, n2) => {
    const o2 = [];
    const s2 = n2 ? isElement(n2) && n2 : document;
    return s2 ? push(o2, s2.querySelectorAll(t3)) : o2;
  };
  var findFirst = (t3, n2) => {
    const o2 = n2 ? isElement(n2) && n2 : document;
    return o2 ? o2.querySelector(t3) : null;
  };
  var is = (t3, n2) => {
    if (isElement(t3)) {
      const o2 = s.matches || s.msMatchesSelector;
      return o2.call(t3, n2);
    }
    return false;
  };
  var contents = (t3) => t3 ? from(t3.childNodes) : [];
  var parent = (t3) => t3 && t3.parentElement;
  var closest = (t3, n2) => {
    if (isElement(t3)) {
      const o2 = s.closest;
      if (o2) {
  ...
  var liesBetween = (t3, n2, o2) => {
    const s2 = closest(t3, n2);
    const e2 = t3 && findFirst(o2, s2);
    const c2 = closest(e2, n2) === s2;
    return s2 && e2 ? s2 === t3 || e2 === t3 || c2 && closest(closest(t3, o2), n2) !== s2 : false;
  };
  var before = (t3, n2, o2) => {
    if (o2 && t3) {
      let s2 = n2;
      ...
      t3.insertBefore(e2, s2 || null);
    }
  };
  var appendChildren = (t3, n2) => {
    before(t3, null, n2);
  };
  var insertBefore = (t3, n2) => {
    before(parent(t3), t3, n2);
  };
  var insertAfter = (t3, n2) => {
    before(parent(t3), t3 && t3.nextSibling, n2);
  };
  var removeElements = (t3) => {
    if (isArrayLike(t3)) {
      each(from(t3), (t4) => removeElements(t4));
    } else if (t3) {
      const n2 = parent(t3);
      if (n2) {
        n2.removeChild(t3);
  ...
  var createDOM = (t3) => {
    const n2 = createDiv();
    n2.innerHTML = t3.trim();
    return each(contents(n2), (t4) => removeElements(t4));
  };
  var firstLetterToUpper = (t3) => t3.charAt(0).toUpperCase() + t3.slice(1);
  ...
  var cssProperty = (t3) => {
    let n2 = l[t3];
    if (hasOwnProperty(l, t3)) {
      return n2;
    }
    const o2 = firstLetterToUpper(t3);
    const s2 = getDummyStyle();
    each(e, (e2) => {
      const c2 = e2.replace(/-/g, "");
      const r2 = [t3, e2 + t3, c2 + o2, firstLetterToUpper(c2) + o2];
      return !(n2 = r2.find((t4) => s2[t4] !== void 0));
    });
    return l[t3] = n2 || "";
  };
  var jsAPI = (t3) => {
    if (isClient()) {
      let n2 = r[t3] || window[t3];
      if (hasOwnProperty(r, t3)) {
        return n2;
      }
      each(c, (o2) => {
        n2 = n2 || window[o2 + firstLetterToUpper(t3)];
        return !n2;
      });
      r[t3] = n2;
      return n2;
  ...
  var v = /[^\x20\t\r\n\f]+/g;
  var classListAction = (t3, n2, o2) => {
    const s2 = t3 && t3.classList;
    let e2;
    let c2 = 0;
    let r2 = false;
  ...
  var removeClass = (t3, n2) => {
    classListAction(t3, n2, (t4, n3) => t4.remove(n3));
  };
  var addClass = (t3, n2) => {
    classListAction(t3, n2, (t4, n3) => t4.add(n3));
    return removeClass.bind(0, t3, n2);
  };
  var { max: p } = Math;
  var equal = (t3, n2, o2, s2) => {
    if (t3 && n2) {
      let e2 = true;
      each(o2, (o3) => {
        const c2 = s2 ? s2(t3[o3]) : t3[o3];
  ...
  var equalWH = (t3, n2) => equal(t3, n2, ["w", "h"]);
  var equalXY = (t3, n2) => equal(t3, n2, ["x", "y"]);
  var equalTRBL = (t3, n2) => equal(t3, n2, ["t", "r", "b", "l"]);
  var equalBCRWH = (t3, n2, o2) => equal(t3, n2, ["width", "height"], o2 && ((t4) => Math.round(t4)));
  var noop = () => {
  };
  var selfClearTimeout = (t3) => {
    let n2;
    const o2 = t3 ? h : d;
    const s2 = t3 ? g : f;
    return [(e2) => {
      s2(n2);
      n2 = o2(e2, isFunction(t3) ? t3() : t3);
    }, () => s2(n2)];
  };
  var debounce = (t3, n2) => {
    let o2;
    ...
    const mergeParms = (t4) => i2 && s2 ? i2(s2, t4) : t4;
    const flush = () => {
      if (c2 !== noop) {
        a2(mergeParms(e2) || e2);
      }
  ...
  var parseToZeroOrNumber = (t3, n2) => {
    const o2 = t3 || "";
    const s2 = n2 ? parseFloat(o2) : parseInt(o2, 10);
    return s2 === s2 ? s2 : 0;
  };
  var adaptCSSVal = (t3, n2) => !w[t3] && isNumber(n2) ? `${n2}px` : n2;
  var getCSSVal = (t3, n2, o2) => String((n2 != null ? n2[o2] || n2.getPropertyValue(o2) : t3.style[o2]) || "");
  var setCSSVal = (t3, n2, o2) => {
    try {
      const { style: s2 } = t3;
  ...
  var directionIsRTL = (t3) => style(t3, "direction") === "rtl";
  var topRightBottomLeft = (t3, n2, o2) => {
    const s2 = n2 ? `${n2}-` : "";
    const e2 = o2 ? `-${o2}` : "";
    const c2 = `${s2}top${e2}`;
  ...
  var getTrasformTranslateValue = (t3, n2) => `translate${isArray(t3) ? `(${t3[0]},${t3[1]})` : `${n2 ? "X" : "Y"}(${t3})`}`;
  var { round: b } = Math;
  var m = {
    w: 0,
    h: 0
  };
  var offsetSize = (t3) => t3 ? {
    w: t3.offsetWidth,
    h: t3.offsetHeight
  } : m;
  var clientSize = (t3) => t3 ? {
    w: t3.clientWidth,
    h: t3.clientHeight
  } : m;
  var scrollSize = (t3) => t3 ? {
    w: t3.scrollWidth,
    h: t3.scrollHeight
  } : m;
  var fractionalSize = (t3) => {
    const n2 = parseFloat(style(t3, "height")) || 0;
    const o2 = parseFloat(style(t3, "width")) || 0;
    return {
      w: o2 - b(o2),
      h: n2 - b(n2)
    };
  };
  var getBoundingClientRect = (t3) => t3.getBoundingClientRect();
  var domRectHasDimensions = (t3) => !!(t3 && (t3.height || t3.width));
  var y;
  ...
  var splitEventNames = (t3) => t3.split(" ");
  var off = (t3, n2, o2, s2) => {
    each(splitEventNames(n2), (n3) => {
      t3.removeEventListener(n3, o2, s2);
    });
  };
  var on = (t3, n2, o2, s2) => {
    var e2;
    ...
    each(splitEventNames(n2), (n3) => {
      const s3 = i2 ? (e3) => {
        t3.removeEventListener(n3, s3, l2);
        o2 && o2(e3);
      } : o2;
      push(a2, off.bind(null, t3, n3, s3, l2));
      t3.addEventListener(n3, s3, u2);
    });
    return runEachAndClear.bind(0, a2);
  };
  var stopPropagation = (t3) => t3.stopPropagation();
  var preventDefault = (t3) => t3.preventDefault();
  var S = {
    x: 0,
    y: 0
  };
  var absoluteCoordinates = (t3) => {
    const n2 = t3 ? getBoundingClientRect(t3) : 0;
    return n2 ? {
      x: n2.left + window.pageYOffset,
      y: n2.top + window.pageXOffset
    } : S;
  };
  var manageListener = (t3, n2) => {
    each(isArray(n2) ? n2 : [n2], t3);
  };
  var createEventListenerHub = (t3) => {
    const n2 = /* @__PURE__ */ new Map();
    const removeEvent = (t4, o2) => {
      if (t4) {
        const s2 = n2.get(t4);
        manageListener((t5) => {
          if (s2) {
            s2[t5 ? "delete" : "clear"](t5);
          }
        }, o2);
      } else {
        n2.forEach((t5) => {
    ...
    const addEvent = (t4, o2) => {
      if (isString(t4)) {
        const s3 = n2.get(t4) || /* @__PURE__ */ new Set();
        n2.set(t4, s3);
        manageListener((t5) => {
          isFunction(t5) && s3.add(t5);
        }, o2);
        return removeEvent.bind(0, t4, o2);
      }
      if (isBoolean(o2) && o2) {
        removeEvent();
      }
  ...
  var opsStringify = (t3) => JSON.stringify(t3, (t4, n2) => {
    if (isFunction(n2)) {
      throw new Error();
    }
    return n2;
  ...
  var getOptionsDiff = (t3, n2) => {
    const o2 = {};
    const s2 = keys(n2).concat(keys(t3));
    each(s2, (s3) => {
      const e2 = t3[s3];
      const c2 = n2[s3];
  ...
  var Mt;
  var getNativeScrollbarSize = (t3, n2, o2, s2) => {
  ...
  var getNativeScrollbarsHiding = (t3) => {
    let n2 = false;
    const o2 = addClass(t3, z);
    try {
      n2 = style(t3, cssProperty("scrollbar-width")) === "none" || window.getComputedStyle(t3, "::-webkit-scrollbar").getPropertyValue("display") === "none";
    } catch (s2) {
    }
    o2();
    return n2;
  };
  var getRtlScrollBehavior = (t3, n2) => {
    const o2 = "hidden";
    style(t3, {
      overflowX: o2,
      overflowY: o2,
    ...
    scrollLeft(t3, 0);
    const s2 = absoluteCoordinates(t3);
  ...
  var getFlexboxGlue = (t3, n2) => {
    const o2 = addClass(t3, O);
    const s2 = getBoundingClientRect(t3);
    const e2 = getBoundingClientRect(n2);
    const c2 = equalBCRWH(e2, s2, true);
    const r2 = addClass(t3, T);
    const l2 = getBoundingClientRect(t3);
  ...
  var createEnvironment = () => {
    ...
    const [r2, l2] = createCache({
      o: getNativeScrollbarSize(t3, o2, s2),
      u: equalXY
    }, getNativeScrollbarSize.bind(0, t3, o2, s2, true));
    const [i2] = l2();
    ...
    const f2 = {
      elements: {
        host: null,
        padding: !a2,
        viewport: (t4) => a2 && t4 === t4.ownerDocument.body && t4,
        content: false
      },
      scrollbars: {
        slot: true
    ...
    const v2 = {
      ...
      N: e2.bind(0, "r"),
      q: g2,
      F: (t4) => assignDeep(f2, t4) && g2(),
      G: h2,
      X: (t4) => assignDeep(d2, t4) && h2(),
      U: assignDeep({}, f2),
      W: assignDeep({}, d2)
    };
    const p2 = window.addEventListener;
    const w2 = debounce((t4) => c2(t4 ? "z" : "r"), {
      g: 33,
      v: 99
    });
    removeAttr(o2, "style");
  ...
  var resolveInitialization = (t3, n2) => isFunction(n2) ? n2.apply(0, t3) : n2;
  var staticInitializationElement = (t3, n2, o2, s2) => {
    const e2 = isUndefined(s2) ? o2 : s2;
    const c2 = resolveInitialization(t3, e2);
    return c2 || n2.apply(0, t3);
  };
  var dynamicInitializationElement = (t3, n2, o2, s2) => {
    const e2 = isUndefined(s2) ? o2 : s2;
    const c2 = resolveInitialization(t3, e2);
    return !!c2 && (isHTMLElement(c2) ? c2 : n2.apply(0, t3));
  };
  var cancelInitialization = (t3, n2, o2) => {
    ...
    const d2 = t3 && (isNull(u2) ? !r2 : u2);
    return !!f2 || !!d2;
  };
  var Dt = /* @__PURE__ */ new WeakMap();
  var addInstance = (t3, n2) => {
    Dt.set(t3, n2);
  };
  var removeInstance = (t3) => {
    Dt.delete(t3);
  };
  var getInstance = (t3) => Dt.get(t3);
  var getPropByPath = (t3, n2) => t3 ? n2.split(".").reduce((t4, n3) => t4 && hasOwnProperty(t4, n3) ? t4[n3] : void 0, t3) : void 0;
  var createOptionCheck = (t3, n2, o2) => (s2) => [getPropByPath(t3, s2), o2 || getPropByPath(n2, s2) !== void 0];
  var createState = (t3) => {
    let n2 = t3;
    return [() => n2, (t4) => {
      n2 = assignDeep({}, n2, t4);
  ...
  var unwrap = (t3) => {
    appendChildren(parent(t3), contents(t3));
    removeElements(t3);
  };
  var createStructureSetupElements = (t3) => {
    ...
    const Q2 = {
      ...
      ft: M2,
      dt: V2,
      _t: (t4, n3) => hasAttrClass(X2, M2 ? A : R, M2 ? n3 : t4),
      ht: (t4, n3, o3) => attrClass(X2, M2 ? A : R, M2 ? n3 : t4, o3)
    };
    const tt2 = keys(Q2).reduce((t4, n3) => {
      const o3 = Q2[n3];
      return push(t4, o3 && isHTMLElement(o3) && !parent(o3) ? o3 : false);
    }, []);
    const elementIsGenerated = (t4) => t4 ? indexOf(tt2, t4) > -1 : null;
    ...
    let at2 = b2 ? nt2 : contents([ct2, et2, st2, ot2, nt2].find((t4) => elementIsGenerated(t4) === false));
    ...
    const appendElements = () => {
      ...
      const t4 = S2 && !M2 ? addClass(parent(w2), z) : noop;
      if (it2) {
        insertAfter(nt2, ot2);
        push(lt2, () => {
          insertAfter(ot2, nt2);
      ...
      if (K2) {
        const t5 = attr(et2, Rt);
        attr(et2, Rt, "-1");
        et2.focus();
        const revertViewportTabIndex = () => t5 ? attr(et2, Rt, t5) : removeAttr(et2, Rt);
  ...
  var createTrinsicUpdateSegment = (t3, n2) => {
    const { nt: o2 } = t3;
    const [s2] = n2;
    return (t4) => {
  ...
  var createPaddingUpdateSegment = (t3, n2) => {
    const [o2, s2] = n2;
    const { J: e2, tt: c2, K: r2, ft: l2 } = t3;
    ...
    return (t4, n3, e3) => {
      ...
      if (y2) {
        ...
        const o3 = u2.t + u2.b;
        const e4 = {
          marginRight: t5 && !h2 ? -n4 : 0,
          marginBottom: t5 ? -o3 : 0,
          marginLeft: t5 && h2 ? -n4 : 0,
          top: t5 ? -u2.t : 0,
          right: t5 ? h2 ? -u2.r : "auto" : 0,
          left: t5 ? h2 ? "auto" : -u2.l : 0,
          width: t5 ? `calc(100% + ${n4}px)` : ""
        };
        const l3 = {
          paddingTop: t5 ? u2.t : 0,
          paddingRight: t5 ? u2.r : 0,
          paddingBottom: t5 ? u2.b : 0,
          paddingLeft: t5 ? u2.l : 0
        };
        style(c2 || r2, e4);
        style(r2, l3);
        s2({
  ...
  var overflowIsVisible = (t3) => t3.indexOf(Yt) === 0;
  var createOverflowUpdateSegment = (t3, n2) => {
    const [o2, s2] = n2;
    const { J: e2, tt: c2, K: r2, ot: l2, ft: i2, ht: a2, it: u2, ct: f2 } = t3;
    ...
    const getViewportOverflowState = (t4, n3) => {
      const o3 = !h2 && !t4 ? Nt : 0;
      const getStatePerAxis = (t5, s4, e4) => {
        const c4 = style(r2, t5);
        const l4 = n3 ? n3[t5] : c4;
        const i4 = l4 === "scroll";
        const a4 = s4 ? o3 : e4;
        const u4 = i4 && !h2 ? a4 : 0;
        const f4 = s4 && !!o3;
    ...
    const setViewportOverflowState = (t4, n3, o3, s3) => {
      const setAxisOverflowStyle = (t5, n4) => {
        const o4 = overflowIsVisible(t5);
        const s4 = n4 && o4 && t5.replace(`${Yt}-`, "") || "";
        return [n4 && !o4 ? t5 : "", overflowIsVisible(s4) ? "hidden" : s4];
      };
      ...
      return getViewportOverflowState(t4, s3);
    };
    const hideNativeScrollbars = (t4, n3, s3, e3) => {
      const { M: c3, D: r3 } = t4;
      const { x: l3, y: i3 } = r3;
      const { x: a3, y: u3 } = c3;
      const { P: f3 } = o2();
    ...
    return (t4, n3, l3) => {
      const { wt: u3, Tt: d3, bt: v3, xt: p3, vt: M2, St: D2 } = t4;
      ...
      if (p3 || D2 || ft2 || at2 || ct2 || lt2 || X2 || F2 || W2) {
        ...
        const n4 = setViewportOverflowState(U2, dt2, G2, t5);
        const o3 = z2(n4, it2, ut2, N2);
        if (!i2) {
          hideNativeScrollbars(n4, N2, o3, t5);
        }
        if (W2) {
          fixFlexboxGlue(n4, k2);
        }
        if (i2) {
          attr(e2, I, t5.overflowX);
          attr(e2, H, t5.overflowY);
        } else {
          style(r2, t5);
        }
      }
  ...
  var prepareUpdateHints = (t3, n2, o2) => {
    const s2 = {};
    const e2 = n2 || {};
    const c2 = keys(t3).concat(keys(e2));
    each(c2, (n3) => {
      const c3 = t3[n3];
      const r2 = e2[n3];
      s2[n3] = !!(o2 || c3 || r2);
  ...
  var createStructureSetupUpdate = (t3, n2) => {
    const { Z: o2, K: s2, ht: e2, ft: c2 } = t3;
    const { A: r2, I: l2, Y: i2 } = getEnvironment();
    const a2 = !r2 && (l2.x || l2.y);
    const u2 = [createTrinsicUpdateSegment(t3, n2), createPaddingUpdateSegment(t3, n2), createOverflowUpdateSegment(t3, n2)];
    return (t4, n3, r3) => {
      ...
      let h2 = l3;
      each(u2, (n4) => {
        h2 = prepareUpdateHints(h2, n4(h2, t4, !!r3) || {}, r3);
      });
      scrollLeft(s2, d2);
      scrollTop(s2, _2);
      e2("", D);
  ...
  var createEventContentChange = (t3, n2, o2) => {
    let s2;
    let e2 = false;
    const destroy = () => {
      e2 = true;
    ...
    const updateElements = (c2) => {
      if (o2) {
        const r2 = o2.reduce((n3, o3) => {
          if (o3) {
            const [s3, e3] = o3;
            const r3 = e3 && s3 && (c2 ? c2(s3) : find(s3, t3));
        ...
        each(r2, (o3) => each(o3[0], (c3) => {
          const r3 = o3[1];
          const l2 = s2.get(c3) || [];
          const i2 = t3.contains(c3);
          if (i2) {
            const t4 = on(c3, r3, (o4) => {
              if (e2) {
                t4();
                s2.delete(c3);
              } else {
  ...
  var createDOMObserver = (t3, n2, o2, s2) => {
    let e2 = false;
    ...
    const [_2, h2] = createEventContentChange(t3, d2, l2);
    const g2 = c2 || [];
    const v2 = r2 || [];
    ...
    const observerCallback = (e3, c3) => {
      ...
      each(e3, (o3) => {
        ...
        if (n2 && (b2 || !m2)) {
          ...
          const v3 = _4 && !l3(o3, !!d4, t3, s2);
          each(h3, (t4) => i2.add(t4));
          each(p3, (t4) => i2.add(t4));
          g3 = g3 || v3;
        }
      ...
      if (i2.size > 0) {
        h2((t4) => from(i2).reduce((n3, o3) => {
          push(n3, find(t4, o3));
          return is(o3, t4) ? push(n3, o3) : n3;
        }, []));
      }
      if (n2) {
        !c3 && g3 && o2(false);
    ...
    const w2 = new i((t4) => observerCallback(t4));
    w2.observe(t3, {
      attributes: true,
    ...
    return [() => {
      ...
      if (e2) {
        d2.m();
        const t4 = w2.takeRecords();
        return !isEmptyArray(t4) && observerCallback(t4, true);
      }
    }];
  };
  var Gt = 3333333;
  var createSizeObserver = (t3, n2, o2) => {
    ...
    const f2 = directionIsRTL.bind(0, t3);
    const [d2] = createCache({
      o: false,
      _: true,
      u: (t4, n3) => !(!t4 || !domRectHasDimensions(t4) && domRectHasDimensions(n3))
    });
    const onSizeChangedCallbackProxy = (t4) => {
      const o3 = isArray(t4) && t4.length > 0 && isObject(t4[0]);
      const e3 = !o3 && isBoolean(t4[0]);
      let c3 = false;
      let l3 = false;
      let a3 = true;
      if (o3) {
        const [n3, , o4] = d2(t4.pop().contentRect);
      ...
      if (s2 && a3) {
        const n3 = e3 ? t4[0] : directionIsRTL(i2);
    ...
    return [() => {
      ...
      if (u) {
        const t4 = new u(onSizeChangedCallbackProxy);
        t4.observe(a2);
        push(_2, () => {
          t4.disconnect();
        });
      } else if (c2) {
        const [t4, o3] = c2.O(a2, onSizeChangedCallbackProxy, e2);
        n3 = t4;
        push(_2, o3);
      }
      if (s2) {
        const [t4] = createCache({
          o: void 0
        }, f2);
      ...
      if (u || c2) {
        appendChildren(t3, i2);
      }
    }];
  };
  var isHeightIntrinsic = (t3) => t3.h === 0 || t3.isIntersecting || t3.intersectionRatio > 0;
  var createTrinsicObserver = (t3, n2) => {
    let o2;
    ...
    const triggerOnTrinsicChangedCallback = (t4, o3) => {
      if (t4) {
        const s3 = c2(isHeightIntrinsic(t4));
        const [, e3] = s3;
        return e3 && !o3 && n2(s3) && [s3];
      }
    };
    const intersectionObserverCallback = (t4, n3) => t4 && t4.length > 0 && triggerOnTrinsicChangedCallback(t4.pop(), n3);
    return [() => {
      runEachAndClear(e2);
      removeElements(s2);
    }, () => {
      if (a) {
        o2 = new a((t4) => intersectionObserverCallback(t4), {
          root: t3
        });
        o2.observe(s2);
        push(e2, () => {
        ...
        const onSizeChanged = () => {
          const t5 = offsetSize(s2);
          triggerOnTrinsicChangedCallback(t5);
        };
        const [t4, n3] = createSizeObserver(s2, onSizeChanged);
        push(e2, t4);
        n3();
        onSizeChanged();
      }
      appendChildren(t3, s2);
  ...
  var createStructureSetupObservers = (t3, n2, o2) => {
    let s2;
    let e2;
    let c2;
    const { J: r2, K: l2, nt: i2, lt: a2, ft: f2, _t: d2, ht: _2 } = t3;
    ...
    const p2 = debounce(o2, {
      ...
      p(t4, n3) {
        const [o3] = t4;
        const [s3] = n3;
        return [keys(o3).concat(keys(s3)).reduce((t5, n4) => {
          t5[n4] = o3[n4] || s3[n4];
          return t5;
        }, {})];
      }
    });
    const updateViewportAttrsFromHost = (t4) => {
      each(t4 || Wt, (t5) => {
        if (indexOf(Wt, t5) > -1) {
          const n3 = attr(r2, t5);
          if (isString(n3)) {
    ...
    const onSizeChanged = ({ wt: t4, jt: s3, Pt: e3 }) => {
      const c3 = !t4 || e3 ? o2 : p2;
      let r3 = false;
      if (s3) {
        const [t5, o3] = s3;
        r3 = o3;
    ...
    const onHostMutation = (t4, n3, o3) => {
      ...
      if (n3) {
        ...
        updateViewportAttrsFromHost(t4);
      }
      return s3;
    };
    ...
    let C2;
    const O2 = f2 && u && new u((t4) => {
      const n3 = t4[t4.length - 1].contentRect;
    ...
    return [() => {
      ...
      const s3 = c2 && c2[1]();
      if (n3) {
        assignDeep(t4, onHostMutation.apply(0, push(n3, true)));
      }
      if (o3) {
        assignDeep(t4, onTrinsicChanged.apply(0, push(o3, true)));
      }
      if (s3) {
        assignDeep(t4, onContentMutation.apply(0, push(s3, true)));
      }
      return t4;
    }, (t4) => {
      const [n3] = t4("update.ignoreMutation");
      const [o3, r3] = t4("update.attributes");
      const [a3, u2] = t4("update.elementEvents");
      const [d3, _3] = t4("update.debounce");
      const h3 = u2 || r3;
      const ignoreMutationFromOptions = (t5) => isFunction(n3) && n3(t5);
      if (h3) {
        if (c2) {
          c2[1]();
          c2[0]();
        ...
        c2 = createDOMObserver(i2 || l2, true, onContentMutation, {
          ...
          kt: Xt,
          Vt: (t5, n4) => {
            const { target: o4, attributeName: s3 } = t5;
            const e3 = !n4 && s3 && !f2 ? liesBetween(o4, Xt, Ut) : false;
            return e3 || !!closest(o4, `.${Q}`) || !!ignoreMutationFromOptions(t5);
          }
        });
      }
      if (_3) {
  ...
  var createInitialStructureSetupUpdateState = (t3) => ({
    tt: {
      t: 0,
      r: 0,
      b: 0,
  ...
  var createStructureSetup = (t3, n2) => {
    ...
    const [_2, h2, g2, v2] = createStructureSetupObservers(r2, f2, (t4) => triggerUpdateEvent(d2(o2, t4), {}, false));
    const p2 = u2.bind(0);
    p2.Nt = (t4) => s2("u", t4);
    p2.qt = () => {
      const { Z: t4, K: n3, rt: o3, it: s3 } = r2;
      const e3 = s3 ? o3.documentElement : t4;
    ...
    p2.Ft = r2;
    return [(t4, o3) => {
      const s3 = createOptionCheck(n2, t4, o3);
      v2(s3);
      return triggerUpdateEvent(d2(s3, g2(), o3), t4, !!o3);
    }, p2, () => {
      e2();
      _2();
      i2();
  ...
  var { round: Qt } = Math;
  var getScale = (t3) => {
    const { width: n2, height: o2 } = getBoundingClientRect(t3);
    const { w: s2, h: e2 } = offsetSize(t3);
    return {
      x: Qt(n2) / s2 || 1,
      y: Qt(o2) / e2 || 1
    };
  };
  var continuePointerDown = (t3, n2, o2) => {
    const s2 = n2.scrollbars;
    const { button: e2, isPrimary: c2, pointerType: r2 } = t3;
  ...
  var createRootClickStopPropagationEvents = (t3, n2) => on(t3, "mousedown", on.bind(0, n2, "click", stopPropagation, {
    C: true,
    $: true
  }), {
    $: true
  });
  var createInteractiveScrollEvents = (t3, n2, o2, s2, e2, c2, r2) => {
    ...
    const g2 = r2 ? "w" : "h";
    const v2 = r2 ? "x" : "y";
    const createRelativeHandleMove = (t4, n3) => (o3) => {
      const { Et: s3 } = c2();
    ...
    return on(a2, "pointerdown", (s3) => {
      ...
      if (continuePointerDown(s3, t3, c3)) {
        const t4 = !c3 && s3.shiftKey;
        const getHandleRect = () => getBoundingClientRect(i2);
        const getTrackRect = () => getBoundingClientRect(a2);
        const getHandleOffset = (t5, n3) => (t5 || getHandleRect())[h2] - (n3 || getTrackRect())[h2];
        ...
        const m2 = u3 - p2[h2];
        const y2 = c3 ? 0 : m2 - b2;
        const releasePointerCapture = (t5) => {
          runEachAndClear(S2);
          r3.releasePointerCapture(t5.pointerId);
        };
        const S2 = [attrClass.bind(0, n2, A, M), on(o2, tn, releasePointerCapture), on(o2, "selectstart", (t5) => preventDefault(t5), {
          S: false
        ...
        if (t4) {
          ...
          const t5 = getPlugins()[Lt];
          if (t5) {
            push(S2, t5.O(l3, getHandleOffset, y2, w2, m2));
          }
        }
  ...
  var createScrollbarsSetupEvents = (t3, n2) => (o2, s2, e2, c2, r2, l2, i2) => {
    const { Ut: a2 } = o2;
    ...
    return runEachAndClear.bind(0, [on(a2, "pointerenter", () => {
      ...
      const { deltaX: n3, deltaY: o3, deltaMode: e3 } = t4;
      ...
      S: false,
      $: true
    }), createRootClickStopPropagationEvents(a2, e2), createInteractiveScrollEvents(t3, c2, e2, o2, r2, n2, i2), f2]);
  };
  var { min: nn, max: sn, round: en } = Math;
  var getScrollbarHandleLengthRatio = (t3, n2, o2, s2) => {
    if (s2) {
      const t4 = o2 ? "x" : "y";
    ...
    const c2 = getBoundingClientRect(t3)[e2];
    const r2 = getBoundingClientRect(n2)[e2];
    return sn(0, nn(1, c2 / r2));
  };
  var getScrollbarHandleOffsetRatio = (t3, n2, o2, s2, e2, c2) => {
    const { V: r2 } = getEnvironment();
    const l2 = c2 ? "x" : "y";
    ...
    const h2 = d2 ? _2 : f2;
    const g2 = nn(1, h2 / u2);
    const v2 = getScrollbarHandleLengthRatio(t3, n2, c2);
    return 1 / v2 * (1 - v2) * g2;
  };
  var animateElement = (t3, n2, o2, s2) => n2 && t3.animate(o2, {
    timeline: n2,
    composite: s2
  });
  var getScrollbarHandleAnimationKeyFrames = (t3, n2) => ({
    transform: [getTrasformTranslateValue(`0%`, n2), getTrasformTranslateValue(n2 && t3 ? "100%" : "-100%", n2)],
    [n2 ? t3 ? "right" : "left" : "top"]: ["0%", "100%"]
  });
  var maxScrollbarOffsetFrameValue = (t3) => `${Math.max(0, t3 - 0.5)}px`;
  var animateScrollbarOffset = (t3, n2, o2, s2) => animateElement(t3, n2, {
    transform: [getTrasformTranslateValue(`0px`, s2), getTrasformTranslateValue(maxScrollbarOffsetFrameValue(o2), s2)]
  }, "add");
  var initScrollTimeline = (t3, n2) => _ ? new _({
    source: t3,
    axis: n2
  }) : null;
  var createScrollbarsSetupElements = (t3, n2, o2) => {
    const { q: s2, H: e2 } = getEnvironment();
    const { scrollbars: c2 } = s2();
    const { slot: r2 } = c2;
    const { rt: l2, Z: i2, J: a2, K: u2, ut: f2, st: d2, it: _2, ft: g2 } = n2;
    const { scrollbars: v2 } = f2 ? {} : t3;
    const { slot: p2 } = v2 || {};
    ...
    const doRefreshScrollbarOffset = (t4) => g2 && !_2 && parent(t4) === u2;
    const cancelElementAnimations = (t4) => {
      w2.forEach((n3, o3) => {
        const s3 = t4 ? indexOf(isArray(t4) ? t4 : [t4], o3) > -1 : true;
        if (s3) {
          (n3 || []).forEach((t5) => {
            t5 && t5.cancel();
          });
    ...
    const scrollbarStructureAddRemoveClass = (t4, n3, o3) => {
      const s3 = o3 ? addClass : removeClass;
      each(t4, (t5) => {
        s3(t5.Ut, n3);
      });
    };
    const scrollbarStyle = (t4, n3) => {
      each(t4, (t5) => {
        const [o3, s3] = n3(t5);
        style(o3, s3);
      });
    };
    const scrollbarStructureRefreshHandleLength = (t4, n3, o3) => {
      scrollbarStyle(t4, (t5) => {
        const { Gt: s3, Xt: e3 } = t5;
        return [s3, {
          [o3 ? "width" : "height"]: `${(getScrollbarHandleLengthRatio(s3, e3, o3, n3) * 100).toFixed(3)}%`
        }];
      });
    };
    const scrollbarStructureRefreshHandleOffset = (t4, n3, o3) => {
      if (!m2 && !m2) {
        scrollbarStyle(t4, (t5) => {
          const { Gt: s3, Xt: e3, Ut: c3 } = t5;
    ...
    const styleScrollbarPosition = (t4) => {
      const { Ut: n3 } = t4;
    ...
    const $2 = [];
    const x2 = [];
    const scrollbarsAddRemoveClass = (t4, n3, o3) => {
      const s3 = isBoolean(o3);
      const e3 = s3 ? o3 : true;
      const c3 = s3 ? !o3 : true;
      e3 && scrollbarStructureAddRemoveClass($2, t4, n3);
      c3 && scrollbarStructureAddRemoveClass(x2, t4, n3);
    };
    const refreshScrollbarsHandleLength = (t4) => {
      scrollbarStructureRefreshHandleLength($2, t4, true);
      scrollbarStructureRefreshHandleLength(x2, t4);
    };
    const refreshScrollbarsHandleOffset = (t4) => {
      scrollbarStructureRefreshHandleOffset($2, t4, true);
      scrollbarStructureRefreshHandleOffset(x2, t4);
    };
    const refreshScrollbarsHandleOffsetTimeline = () => {
      const forEachFn = (t4, { Ut: n3, Gt: o3 }) => {
        cancelElementAnimations(o3);
        w2.set(o3, [animateElement(o3, t4 ? b2 : m2, getScrollbarHandleAnimationKeyFrames(t4 && directionIsRTL(n3), t4))]);
      };
    ...
    const refreshScrollbarsScrollbarOffsetTimeline = ({ Et: t4 }) => {
      x2.concat($2).forEach(({ Ut: n3 }) => {
        cancelElementAnimations(n3);
        if (doRefreshScrollbarOffset(n3)) {
          w2.set(n3, [animateScrollbarOffset(n3, b2, t4.x, true), animateScrollbarOffset(n3, m2, t4.y)]);
        }
      });
    };
    const generateScrollbarDOM = (t4) => {
      const n3 = t4 ? nt : ot;
      const s3 = t4 ? $2 : x2;
      ...
      push(s3, f3);
      push(S2, [removeElements.bind(0, r3), cancelElementAnimations, o2(f3, scrollbarsAddRemoveClass, l2, a2, d2, t4 ? b2 : m2, t4)]);
      return f3;
    };
  ...
  var isHoverablePointerType = (t3) => t3.pointerType === "mouse";
  var createScrollbarsSetup = (t3, n2, o2, s2) => {
    let e2;
    let c2;
    let r2;
    let l2;
    ...
    const [C2, O2, T2] = createScrollbarsSetupElements(t3, o2.Ft, createScrollbarsSetupEvents(n2, o2));
    const { J: z2, et: E2, it: A2 } = o2.Ft;
    const { tn: I2, Wt: H2, Zt: L2, Jt: P2, Kt: M2, Qt: D2 } = C2;
    const manageAutoHideSuspension = (t4) => {
      I2(ut, t4, true);
      I2(ut, t4, false);
    };
    const manageScrollbarsAutoHide = (t4, n3) => {
      x2();
      if (t4) {
        I2(ft);
      } else {
    ...
    const onHostMouseEnter = (t4) => {
      if (isHoverablePointerType(t4)) {
        l2 = c2;
    ...
    const R2 = [w2, x2, m2, S2, v2, h2, T2, on(z2, "pointerover", onHostMouseEnter, {
      C: true
    }), on(z2, "pointerenter", onHostMouseEnter), on(z2, "pointerleave", (t4) => {
      if (isHoverablePointerType(t4)) {
        l2 = false;
        c2 && manageScrollbarsAutoHide(false);
      }
    }), on(z2, "pointermove", (t4) => {
      isHoverablePointerType(t4) && e2 && _2(() => {
        w2();
    ...
    return [(t4, s3, l3) => {
      ...
      const p3 = createOptionCheck(n2, t4, s3);
      const w3 = o2();
      ...
      const setScrollbarVisibility = (t5, n3) => {
        const o3 = z3 === "visible" || z3 === "auto" && t5 === "scroll";
        I2(ct, o3, n3);
        return o3;
      };
      u2 = j2;
      ...
      if (Z2) {
        const t5 = setScrollbarVisibility(m3.x, true);
  ...
  var invokePluginInstance = (t3, n2, o2) => {
    if (isFunction(t3)) {
      t3(n2 || void 0, o2 || void 0);
    }
  };
  var OverlayScrollbars = (t3, n2, o2) => {
    const { G: s2, q: e2, j: c2, N: r2 } = getEnvironment();
    const l2 = getPlugins();
    const i2 = isHTMLElement(t3);
    const a2 = i2 ? t3 : t3.target;
    const u2 = getInstance(a2);
    if (n2 && !u2) {
      let u3 = false;
      const validateOptions = (t4) => {
        const n3 = getPlugins()[$t];
        const o3 = n3 && n3.O;
        return o3 ? o3(t4, true) : t4;
      };
      const f2 = assignDeep({}, s2(), validateOptions(n2));
      const [d2, _2, h2] = createEventListenerHub(o2);
      const [g2, v2, p2] = createStructureSetup(t3, f2);
      const [w2, b2, m2] = createScrollbarsSetup(t3, f2, v2, (t4) => h2("scroll", [x2, t4]));
      const update = (t4, n3) => g2(t4, !!n3);
      ...
      const x2 = {
        options(t4, n3) {
          if (t4) {
            const o3 = n3 ? s2() : {};
            const e3 = getOptionsDiff(f2, assignDeep(o3, validateOptions(t4)));
            if (!isEmptyObject(e3)) {
              assignDeep(f2, e3);
              update(e3);
            }
        ...
        state() {
          const { zt: t4, Et: n3, Ot: o3, At: s3, tt: e3, $t: c3, yt: r3 } = v2();
          return assignDeep({}, {
            overflowEdge: t4,
            overflowAmount: n3,
            overflowStyle: o3,
        ...
        elements() {
          const { Z: t4, J: n3, tt: o3, K: s3, nt: e3, st: c3, et: r3 } = v2.Ft;
          const { nn: l3, rn: i3 } = b2.Ft;
          const translateScrollbarStructure = (t5) => {
            const { Gt: n4, Xt: o4, Ut: s4 } = t5;
            return {
              scrollbar: s4,
              track: o4,
              handle: n4
          ...
          const translateScrollbarsSetupElement = (t5) => {
            const { sn: n4, en: o4 } = t5;
            const s4 = translateScrollbarStructure(n4[0]);
            return assignDeep({}, s4, {
              clone: () => {
                const t6 = translateScrollbarStructure(o4());
                w2({}, true, {});
                return t6;
              }
            });
      ...
      addInstance(a2, x2);
      each(keys(l2), (t4) => invokePluginInstance(l2[t4], 0, x2));
      if (cancelInitialization(v2.Ft.it, e2().cancel, !i2 && t3.cancel)) {
        destroy(true);
        return x2;
      }
      v2.qt();
      ...
      h2("initialized", [x2]);
      v2.Nt((t4, n3, o3) => {
        const { wt: s3, St: e3, vt: c3, Ht: r3, Lt: l3, It: i3, bt: a3, Tt: u4 } = t4;
        h2("updated", [x2, {
          updateHints: {
            sizeChanged: s3,
            directionChanged: e3,
  ...
  OverlayScrollbars.plugin = (t3) => {
    each(addPlugin(t3), (t4) => invokePluginInstance(t4, OverlayScrollbars));
  };
  OverlayScrollbars.valid = (t3) => {
    const n2 = t3 && t3.elements;
    const o2 = isFunction(n2) && n2();
    return isPlainObject(o2) && !!getInstance(o2.target);
  };
  OverlayScrollbars.env = () => {
    const { k: t3, I: n2, A: o2, V: s2, Y: e2, H: c2, B: r2, U: l2, W: i2, q: a2, F: u2, G: f2, X: d2 } = getEnvironment();
    return assignDeep({}, {
      scrollbarsSize: t3,
...
Review your css class markup or html`
  ...
  var Animate = class {
    advance(e2) {
      ...
      let i2 = false;
      if (this.lerp)
        this.value = (s2 = this.value, o2 = this.to, n2 = 60 * this.lerp, l2 = e2, function(t3, e3, i3) {
          return (1 - i3) * t3 + i3 * e3;
        }(s2, o2, 1 - Math.exp(-n2 * l2))), Math.round(this.value) === this.to && (this.value = this.to, i2 = true);
      else {
        this.currentTime += e2;
        const s3 = t2(0, this.currentTime / this.duration, 1);
        i2 = s3 >= 1;
        const o3 = i2 ? 1 : this.easing(s3);
    ...
    fromTo(t3, e2, { lerp: i2 = 0.1, duration: s2 = 1, easing: o2 = (t4) => t4, onStart: n2, onUpdate: l2 }) {
      this.from = this.value = t3, this.to = e2, this.lerp = i2, this.duration = s2, this.easing = o2, this.currentTime = 0, this.isRunning = true, n2?.(), this.onUpdate = l2;
    }
  };
  var Dimensions = class {
    constructor({ wrapper: t3, content: e2, autoResize: i2 = true, debounce: s2 = 250 } = {}) {
  ...
  var VirtualScroll = class {
    constructor(t3, { wheelMultiplier: e2 = 1, touchMultiplier: i2 = 2, normalizeWheel: s2 = false }) {
    ...
    onTouchMove = (t3) => {
      const { clientX: e2, clientY: i2 } = t3.targetTouches ? t3.targetTouches[0] : t3, s2 = -(e2 - this.touchStart.x) * this.touchMultiplier, o2 = -(i2 - this.touchStart.y) * this.touchMultiplier;
      this.touchStart.x = e2, this.touchStart.y = i2, this.lastDelta = { x: s2, y: o2 }, this.emitter.emit("scroll", { deltaX: s2, deltaY: o2, event: t3 });
    };
    onTouchEnd = (t3) => {
      this.emitter.emit("scroll", { deltaX: this.lastDelta.x, deltaY: this.lastDelta.y, event: t3 });
    };
    onWheel = (e2) => {
      let { deltaX: i2, deltaY: s2 } = e2;
      this.normalizeWheel && (i2 = t2(-100, i2, 100), s2 = t2(-100, s2, 100)), i2 *= this.wheelMultiplier, s2 *= this.wheelMultiplier, this.emitter.emit("scroll", { deltaX: i2, deltaY: s2, event: e2 });
    };
  };
  var Lenis = class {
    constructor({ wrapper: t3 = window, content: e2 = document.documentElement, wheelEventsTarget: i2 = t3, eventsTarget: s2 = i2, smoothWheel: o2 = true, syncTouch: n2 = false, syncTouchLerp: l2 = 0.075, touchInertiaMultiplier: r2 = 35, duration: h2, easing: a2 = (t4) => Math.min(1, 1.001 - Math.pow(2, -10 * t4)), lerp: c2 = !h2 && 0.1, infinite: p2 = false, orientation: u2 = "vertical", gestureOrientation: d2 = "vertical", touchMultiplier: m2 = 1, wheelMultiplier: v2 = 1, normalizeWheel: g2 = false, autoResize: S2 = true, __experimental__naiveDimensions: w2 = false } = {}) {
      this.__isSmooth = false, this.__isScrolling = false, this.__isStopped = false, this.__isLocked = false, this.onVirtualScroll = ({ deltaX: t4, deltaY: e3, event: i3 }) => {
        ...
        const n3 = 0 === t4 && 0 === e3, l3 = "vertical" === this.options.gestureOrientation && 0 === e3 || "horizontal" === this.options.gestureOrientation && 0 === t4;
        if (n3 || l3)
          return;
        let r3 = i3.composedPath();
        if (r3 = r3.slice(0, r3.indexOf(this.rootElement)), r3.find((t5) => {
          var e4, i4, n4, l4, r4;
          return (null === (e4 = t5.hasAttribute) || void 0 === e4 ? void 0 : e4.call(t5, "data-lenis-prevent")) || s3 && (null === (i4 = t5.hasAttribute) || void 0 === i4 ? void 0 : i4.call(t5, "data-lenis-prevent-touch")) || o3 && (null === (n4 = t5.hasAttribute) || void 0 === n4 ? void 0 : n4.call(t5, "data-lenis-prevent-wheel")) || (null === (l4 = t5.classList) || void 0 === l4 ? void 0 : l4.contains("lenis")) && !(null === (r4 = t5.classList) || void 0 === r4 ? void 0 : r4.contains("lenis-stopped"));
        }))
          return;
        ...
        i3.preventDefault();
        let h3 = e3;
        "both" === this.options.gestureOrientation ? h3 = Math.abs(e3) > Math.abs(t4) ? e3 : t4 : "horizontal" === this.options.gestureOrientation && (h3 = t4);
    ...
    scrollTo(e2, { offset: i2 = 0, immediate: s2 = false, lock: o2 = false, duration: n2 = this.options.duration, easing: l2 = this.options.easing, lerp: r2 = !n2 && this.options.lerp, onComplete: h2, force: a2 = false, programmatic: c2 = true } = {}) {
      if (!this.isStopped && !this.isLocked || a2) {
        ...
        if ("number" == typeof e2) {
          if (e2 += i2, e2 = Math.round(e2), this.options.infinite ? c2 && (this.targetScroll = this.animatedScroll = this.scroll) : e2 = t2(0, e2, this.limit), s2)
  ...
  var CustomEase = /* @__PURE__ */ function() {
    ...
    _proto.setData = function setData(data, config3) {
      config3 = config3 || {};
      data = data || "0,0,1,1";
      var values = data.match(_numExp2), closest2 = 1, points = [], lookup = [], precision = config3.precision || 1, fast = precision <= 1, l2, a1, a2, i2, inc, j2, point, prevPoint, p2;
      this.data = data;
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    aNameSections.forEach((section) => {
      const config3 = getConfigByAtt(section, attributeId, true);
    ...
    aNames.forEach((a2) => {
      ...
      if (hrefValue.split("#")[1].length && linkToSamePage(a2)) {
        a2.addEventListener("click", (e2) => {
          e2.preventDefault();
          const target = e2.target.getAttribute("href").split("#")[1];
  ...
  var setupAutoHideHeader = () => {
    ...
    ScrollTrigger2.create({
      ...
      onUpdate: (self) => {
        if (window.pictauMobileNav.showing && self.direction !== -1)
